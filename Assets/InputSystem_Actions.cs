...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""PlantMode"",
            ""id"": ""f593d15b-4fae-4c50-a56c-f12582ec05bd"",
            ""actions"": [
                {
                    ""name"": ""PlantAction"",
                    ""type"": ""Button"",
                    ""id"": ""009b61cb-bcc8-4baa-9e28-070bf275dc46"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""620cf7f0-6072-4e19-b888-0907550b4d2f"",
                    ""path"": ""<Mouse>/rightButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_PlantMode.enabled, "This will cause a leak and performance issues, InputSystem_Actions.PlantMode.Disable() has not been called.");
    }
    ...
    /// </summary>
    public struct PlantModeActions
    {
        private @InputSystem_Actions m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlantModeActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        ...
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_PlantMode; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="PlantModeActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(PlantModeActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="PlantModeActions" />
        public void AddCallbacks(IPlantModeActions instance)
        {
            if (instance == null || m_Wrapper.m_PlantModeActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_PlantModeActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="PlantModeActions" />
        private void UnregisterCallbacks(IPlantModeActions instance)
        {
            @PlantAction.started -= instance.OnPlantAction;
            @PlantAction.performed -= instance.OnPlantAction;
            @PlantAction.canceled -= instance.OnPlantAction;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="PlantModeActions.UnregisterCallbacks(IPlantModeActions)" />.
        /// </summary>
        /// <seealso cref="PlantModeActions.UnregisterCallbacks(IPlantModeActions)" />
        public void RemoveCallbacks(IPlantModeActions instance)
        {
            if (m_Wrapper.m_PlantModeActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="PlantModeActions.AddCallbacks(IPlantModeActions)" />
        /// <seealso cref="PlantModeActions.RemoveCallbacks(IPlantModeActions)" />
        /// <seealso cref="PlantModeActions.UnregisterCallbacks(IPlantModeActions)" />
        public void SetCallbacks(IPlantModeActions instance)
        {
            foreach (var item in m_Wrapper.m_PlantModeActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_PlantModeActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="PlantModeActions" /> instance referencing this action map.
    /// </summary>
    public PlantModeActions @PlantMode => new PlantModeActions(this);
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "PlantMode" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="PlantModeActions.AddCallbacks(IPlantModeActions)" />
    /// <seealso cref="PlantModeActions.RemoveCallbacks(IPlantModeActions)" />
    public interface IPlantModeActions
    {
        /// <summary>
        /// Method invoked when associated input action "PlantAction" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
